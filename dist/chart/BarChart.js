...
var _BarGroup = require('../shape/BarGroup');
  ...
  _createClass(Component, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          barGroupPadding = _props.barGroupPadding,
          barGroupHeadroom = _props.barGroupHeadroom,
          data = _props.data,
          fields = _props.fields,
          axisNames = _props.axisNames;

      var xScale = (0, _scale.createXScale)(data, fields, width).padding(barGroupPadding);
      var yScale = (0, _scale.createYScale)(data, fields, height, barGroupHeadroom);
      return _react2.default.createElement(
        _ChartBase2.default,
        { className: className, width: width, height: height, padding: padding },
        _react2.default.createElement(_BarGroup2.default, { height: height, width: width, xScale: xScale, yScale: yScale, data: data, fields: fields }),
...
Component.propTypes = {
  ...
  barGroupPadding: _propTypes2.default.number,
  barGroupHeadroom: _propTypes2.default.number,
