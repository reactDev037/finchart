...
var Component = exports.Component = function (_PureComponent) {
  ...
  _createClass(Component, [{
    ...
    value: function render() {
      ...
      var axis = (0, _d3Axis.axisLeft)(yScale).tickArguments(tickArguments).ticks(tickArguments ? null : tickAmount).tickFormat(notick ? '' : tickFormat).tickSize(tickSize).tickSizeInner(tickSize ? null : tickSizeInner).tickSizeOuter(tickSize ? null : tickSizeOuter).tickPadding(tickOffset);
...
Component.propTypes = {
  ...
  notick: _propTypes2.default.bool
  // showGrid: PropTypes.bool,
};
Component.defaultProps = {
  tickAmount: 5,
  tickArguments: null,
  tickFormat: (0, _d3Format.format)('.0s'),
  tickSize: 4,
  tickSizeInner: 0,
  tickSizeOuter: 0,
  tickOffset: 5,
